...
export default function SignalAnimation({ className = '', size = 96, color = '#4338CA' }: SignalAnimationProps) {
  return (
    <svg
    ...
    >
      ...
      <path className="signal-outer" fill={color} stroke="none" d="M17.39,15.29c-.19,0-.38-.07-.53-.22-.29-.29-.29-.77,0-1.06,1.7-1.7,2.64-3.96,2.64-6.36s-.94-4.66-2.64-6.36c-.29-.29-.29-.77,0-1.06s.77-.29,1.06,0c1.98,1.98,3.08,4.62,3.08,7.42s-1.09,5.44-3.08,7.42c-.15.15-.34.22-.53.22Z"/>
      <path className="signal-outer" fill={color} stroke="none" d="M3.61,15.29c-.19,0-.38-.07-.53-.22-1.98-1.98-3.08-4.62-3.08-7.42S1.09,2.2,3.08.22c.29-.29.77-.29,1.06,0s.29.77,0,1.06c-1.7,1.7-2.64,3.96-2.64,6.36s.94,4.66,2.64,6.36c.29.29.29.77,0,1.06-.15.15-.34.22-.53.22Z"/>
